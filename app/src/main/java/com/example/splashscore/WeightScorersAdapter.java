...
public class WeightScorersAdapter extends RecyclerView.Adapter<WeightScorersAdapter.Holder> {
    private final List<PlayerStat> items;

    public WeightScorersAdapter(List<PlayerStat> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(@NonNull Holder h, int pos) {
        ...
        // itt a különbség: age helyett weight (kg)
        h.ageGoalsText.setText(p.getWeight() + " kg • " + p.getGoals() + " gól");
    }
